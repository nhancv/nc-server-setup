...
```
ssh-keyscan 192.168.0.105 >> /var/lib/jenkins/.ssh/known_hosts
exit
```
### On jenkins
...
+ Node name: Linux Ci
+ Remote root directory: /home/master-ci/jenkins
+ Labels: linux-ci
+ Usage: Use this node as much as possible
+ Launch method: Launch agent via execution of command on the master
+ Launch command: ssh -i /var/lib/jenkins/.ssh/linux-ci linux-ci@192.168.0.105 "cd /home/linux-ci/jenkins && curl -O http://192.168.0.103/jnlpJars/slave.jar && java -jar slave.jar"
