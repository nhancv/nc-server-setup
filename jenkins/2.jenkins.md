...
+ Launch command: ssh -i /var/lib/jenkins/.ssh/linux-ci linux-ci@192.168.0.107 "cd /home/linux-ci/jenkins && curl -O http://192.168.0.106/jnlpJars/slave.jar && java -jar slave.jar"
